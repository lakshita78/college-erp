    ...
    <header className="fixed top-0 right-0 left-0 lg:left-64 h-16 bg-white/80 dark:bg-dark-800/80 backdrop-blur-xl border-b border-light-600 dark:border-dark-600 z-30 transition-all duration-300">
      <div className="flex items-center justify-between h-full px-4 lg:px-6">
        ...
        <div className="flex items-center gap-4 flex-1">
          <button
            onClick={onMenuClick}
            className="lg:hidden p-2 rounded-lg hover:bg-primary-50 dark:hover:bg-dark-700 text-content-muted dark:text-content-dark-muted"
          >
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={toggleTheme}
            className="p-2 rounded-xl hover:bg-primary-50 dark:hover:bg-dark-700 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-all duration-200"
          >
          ...
          <div className="relative">
            <button
              ...
              className="relative p-2 rounded-xl hover:bg-primary-50 dark:hover:bg-dark-700 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-all duration-200"
            >
                ...
                <div className="absolute right-0 top-full mt-2 w-80 bg-white dark:bg-dark-800 border border-light-600 dark:border-dark-600 rounded-2xl shadow-light-lg dark:shadow-dark-lg z-50 animate-fade-in">
                  ...
                  <div className="max-h-80 overflow-y-auto scrollbar-thin">
                    {notifications.map((notification) => (
                      <div
                        key={notification.id}
                        className="flex items-start gap-3 px-4 py-3 hover:bg-primary-50 dark:hover:bg-dark-700 transition-colors cursor-pointer border-b border-light-600/50 dark:border-dark-600/50 last:border-0"
                      >
                  ...
                  <div className="px-4 py-3 border-t border-light-600 dark:border-dark-600">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-3 pl-2 pr-3 py-1.5 rounded-xl hover:bg-primary-50 dark:hover:bg-dark-700 transition-all duration-200"
            >
              ...
              <ChevronDown className={`w-4 h-4 text-gray-600 dark:text-gray-400 transition-transform duration-200 ${showProfile ? 'rotate-180' : ''}`} />
            </button>
            ...
            {showProfile && (
              <>
                ...
                />
                <div className="absolute right-0 top-full mt-2 w-56 bg-white dark:bg-dark-800 border border-light-600 dark:border-dark-600 rounded-2xl shadow-light-lg dark:shadow-dark-lg z-50 animate-fade-in">
                  <div className="px-4 py-3 border-b border-light-600 dark:border-dark-600">
                    <p className="text-sm font-medium text-gray-900 dark:text-white">{user.name}</p>
                    <p className="text-xs text-gray-600 dark:text-gray-400">{user.email || 'user@example.com'}</p>
                  </div>
                  <ul className="py-2">
                    <li>
                      <button className="flex items-center gap-3 w-full px-4 py-2 text-sm text-gray-600 dark:text-gray-400 hover:bg-primary-50 dark:hover:bg-dark-700 hover:text-gray-900 dark:hover:text-white transition-colors">
                        <User className="w-4 h-4" />
                        Profile
                      </button>
                    </li>
                  ...
                  <div className="px-4 py-2 border-t border-light-600 dark:border-dark-600">
