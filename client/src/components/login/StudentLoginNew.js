  ...
  return (
    <div className="min-h-screen bg-dark-900 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-accent-teal/20 to-accent-purple/20" />
        <div className="absolute top-0 left-0 w-full h-full bg-[url('https://images.unsplash.com/photo-1523050854058-8df90110c9f1?ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=80')] bg-cover bg-center opacity-30" />
        ...
        <div className="relative z-10 flex flex-col justify-between p-12">
          ...
          <div className="max-w-md">
            ...
            <p className="text-gray-400 mb-8">
              Access your courses, check grades, and manage your academic journey.
            </p>
            <div className="space-y-3">
              {[
                'View courses and study materials',
                'Check attendance and grades',
                'Access test results and transcripts',
              ].map((item, index) => (
        ...
        <div className="w-full max-w-md">
          ...
          <Card padding="lg" className="border border-dark-600">
            <div className="text-center mb-8">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-accent-teal to-accent-teal/80 flex items-center justify-center mx-auto mb-4 shadow-dark">
                <School className="w-8 h-8 text-white" />
              </div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Student Login</h1>
