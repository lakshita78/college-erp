    ...
    <div
      ...
      <div className="flex flex-col items-center mt-10 space-y-32">
        ...
        <div className="grid grid-cols-3 gap-14">
          <div className="h-96 w-80 space-y-11 shadow-2xl flex flex-col justify-center items-center bg-transparent backdrop-blur-md bg-[#2d2d2d] bg-opacity-80 rounded-xl">
